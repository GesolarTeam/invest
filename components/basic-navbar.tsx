  ...
  ({classNames = {}, ...props}, ref) => {
    ...
    return (
      <Navbar
        ...
        {...props}
        classNames={{
          base: `${isMenuOpen ? 'border-default-100 bg-transparent bg-default-200/50 dark:bg-default-100/50' : 'border-default-100 bg-transparent'}`,
      ...
      >
        {/* Left Content */}
        <NavbarBrand>
          <span className="ml-2 text-small font-medium text-default-foreground">GESOLAR</span>
        </NavbarBrand>
