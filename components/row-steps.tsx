  ...
  (
    ...
    return (
      <nav aria-label="Progress" className="-my-4 max-w-fit overflow-x-auto py-4">
        <ol className={twMerge("flex flex-row flex-nowrap gap-x-3", colors, className)}>
              ...
              <li key={stepIdx} className="relative flex w-full items-center pr-12">
                ...
                >
                  ...
                  <div className="max-w-full flex-1 text-start">
                    <div
                      className={twMerge(
                        "text-small font-medium text-white transition-[color,opacity] duration-300 group-active:opacity-80 lg:text-medium",
