...
export function Footer() {
  return (
    <footer className="w-full flex items-center justify-center py-12 px-6 md:px-4 md:py-14 bg-white/5">
      <div className="w-full max-w-[1200px] flex flex-col items-start p-2">
        <div className="w-full flex flex-col items-start gap-8 justify-between sm:items-center lg:flex-row">
          <div>
            <div className="flex items-center">
              <img
                src="../assets/Logo branco.amarelo.png"
                className="w-48"
                alt="logo"
              />
            </div>
        ...
        <div className="w-full flex items-start justify-between flex-col gap-2 py-6 mt-8 border-t-2 border-t-white/10 sm:items-center lg:gap-0 lg:flex-row">
          <div>
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="w-[46px] h-[46px] flex items-center justify-center bg-white/10  text-sun-500 rounded-2xl hover:bg-[#1e1e1e] hover:text-amber-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#131313] focus:ring-amber-500 transition-colors duration-200"
            >
